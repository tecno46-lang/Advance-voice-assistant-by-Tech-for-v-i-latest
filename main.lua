                ...
                if f then
                    ...
                    if success then
                        ...
                        mainHandler.post(createRunnable(function()
                            ...
                            successDialog.setButton("Restart Plugin", function()
                                successDialog.dismiss()
                                speak("Restarting plugin")
                                -- Reload only the plugin, not the whole screen reader
                                pcall(function() service.reload() end)
                            end)
                            successDialog.show()
                        end))
                    else
